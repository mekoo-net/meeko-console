...
const tabs = [
  { name: 'demux-settings-rate', label: '总开关', to: '/demux/settings/rate' },
  { name: 'demux-settings-rate-accounts', label: '账户设置', to: '/demux/settings/rate/accounts' },
  { name: 'demux-settings-rate-ip', label: 'IP 设置', to: '/demux/settings/rate/ip' },
] as const;
</script>
...
<template>
  <div class="rate-settings">
    <PageHeader
      title="速率设置"
      description="控制 Demux 网关的账户与 IP 速率限制"
    />
