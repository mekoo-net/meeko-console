...
} from '../ports/demuxRedemptionPort';
import { buildRedemptionSeed, MOCK_STAFF_ADMIN } from './demuxRedemptionMockData';
...
export class DemuxRedemptionMock implements DemuxRedemptionPort {
  async list(input: {
    page: number;
    pageSize: number;
