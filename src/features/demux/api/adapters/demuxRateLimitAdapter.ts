...
import type { DemuxRateLimitPort } from '@/features/demux/services/ports/demuxRateLimitPort';
import { demuxGatewayPaths } from '@/features/demux/api/routes';
import { requestDemuxGateway } from '@/features/demux/api/http';
...
export class DemuxRateLimitHttpAdapter implements DemuxRateLimitPort {
