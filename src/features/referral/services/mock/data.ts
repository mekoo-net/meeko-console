...
export const seedWithdrawals: ReferralWithdrawal[] = [
  {
    id: '30001',
    accountUid: '100000000001',
    accountDisplayName: 'Meeko Demo Org',
    accountEmail: 'owner@demo.test',
    amount: 80,
    currency: 'CNY',
    method: 'alipay',
    accountNo: '138****8001',
  ...
  {
    id: '30003',
    accountUid: '100000000003',
    accountDisplayName: '张三',
    accountEmail: 'zhang@personal.test',
    amount: 50,
    currency: 'CNY',
    method: 'alipay',
    accountNo: '137****7003',
